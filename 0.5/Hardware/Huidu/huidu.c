...
/* 全局变量 */
/* 默认: 普通读高低电平 (8 路 GPIO), 用户 2026-07-17 决定.
 *   MUX_ADC 模式需引脚配 ADC + DMA, 占用多; 默认改成 GPIO 模式
 *   直接读高/低, 主页 ROW 1 用 0/1 二值化展示. 灰度页 K1 仍可切. */
huidu_mode_t     Huidu_Mode = HUIDU_MODE_ALL8_GPIO;
