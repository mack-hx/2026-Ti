/* ============================================================================
 * @file    LCD_Data.h
 * @brief   1.8寸 TFT LCD 字库头文件 - ASCII 字模 + 汉字字模声明
 *
 *   本文件只声明字库 const 数组, 数据实现在 LCD_Data.c.
 *   应用层通过 LCD.h 间接引用本文件; 不应单独 include.
 *
 *   字符集: 默认 UTF8 (LCD_CHARSET_UTF8); 可改为 LCD_CHARSET_GB2312 切回 GB2312.
 * ============================================================================
 */
#ifndef __LCD_DATA_H
#define __LCD_DATA_H
