 ...
 *
 *   应用层通常不直接调本文件 API, 而是通过 stepmotor.h 的高级封装:
...
void PD42S1_SetLimitSwitch(uint8_t addr, bool enable);          /* 0x99 */
