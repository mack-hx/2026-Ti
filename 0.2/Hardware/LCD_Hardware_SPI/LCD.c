 ...
 * ============================================================================
 *
 *   上电:  LCD_Init(BLUE);              // 清屏, 整屏填 BLUE
 *
 *   画图:
 *     LCD_Fill(x0, y0, x1, y1, color);  // 矩形填充 (含端点), 用于清某一行 / 某一块
 ...
 *     LCD_ShowIntNum(x, y, 123, 4, fc, bc, LCD_8X16);   // 4 位整数 (含符号)
 *     LCD_ShowFloatNum(x, y, 1.23, 3, fc, bc, LCD_8X16); // 浮点 (len 含小数位)
 ...
 *     YELLOW / MAGENTA / GRAY / LGRAY / ... 详见 LCD.h
 *
