...
build-476156571: ../empty.syscfg
	@echo 'SysConfig - building file: "$<"'
	"/Users/m/ti/sysconfig_1.26.2/sysconfig_cli.sh" -s "/Users/m/ti/mspm0_sdk_2_10_00_04/.metadata/product.json" --script "/Volumes/Moving/work/01_code/01_Competition/01_ELE_com/2026-TI-Em/2026-TI/0.2/empty.syscfg" -o "." --compiler gcc
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.lds: build-476156571 ../empty.syscfg
device.opt: build-476156571
device.lds.genlibs: build-476156571
ti_msp_dl_config.c: build-476156571
ti_msp_dl_config.h: build-476156571
Event.dot: build-476156571
